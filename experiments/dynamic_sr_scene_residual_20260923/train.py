...
All forks use the same full-RGB mean L1 losses, retaining people and complex
backgrounds. No mask input, temporal teacher aggregation, extra detail
regularizers, HR target reads or densification.
"""
...
from residual_model import (BRANCHES, OLD, ROOT, detail_state, make_model,
                            render_model)
