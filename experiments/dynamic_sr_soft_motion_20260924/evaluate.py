#!/usr/bin/env python3
"""Fixed float-render evaluation for A/B/C and ordinary-forward soft-motion S.
...
def main():
    ...
    parser.add_argument('--prior-cameras', help='Four training teacher cameras; default follows dataset family')
    parser.add_argument('--method', help='Display identity, e.g. A/B/C/S; forward branch still recorded separately')
